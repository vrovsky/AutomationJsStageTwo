...
class CloudGooglePage extends Page {
  ...
  async find_emailEstimateBtn() {
    await driver
      .findElement(By.xpath('//button[@aria-label="Email Estimate"]'))
      .click();
  }
  async find_emailfield(generatedMail) {
    await driver
      .findElement(By.xpath('//input[@type="email"]'))
      .sendKeys(generatedMail);
  }
  async find_sendEmailBtn() {
    await driver
      .findElement(By.xpath('//button[@aria-label="Send Email"]'))
      .click();
  }
