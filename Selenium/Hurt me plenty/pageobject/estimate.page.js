...
class EstimatePage extends Page {
  constructor() {
    ...
    this.vmClassSelected =
      '#compute > md-list > md-list-item:nth-child(8) > div';
    this.instanceTypeSelected =
      '#compute > md-list > md-list-item:nth-child(10) > div.md-list-item-text.ng-binding.cpc-cart-multiline.flex';
    this.localSDDSelected =
      '#compute > md-list > md-list-item:nth-child(14) > div.md-list-item-text.ng-binding.cpc-cart-multiline.flex';
    this.regionSelected =
      '#compute > md-list > md-list-item:nth-child(2) > div';
    this.commitmentTermSelected =
      '#compute > md-list > md-list-item:nth-child(6) > div';
    this.estimatedCost =
